...
class CalendarClient:
  ...
  def print_all_events(self):
    ...
    for i, a_calendar in zip(xrange(len(feed.entry)), feed.entry):
      ...
      query = gdata.calendar.client.CalendarEventQuery(start_min='2004-01-01', start_max='2034-01-01',max_results=10000,text_query="CTC's Enticer, Sprint, Olympic Triathlon, Oct 28th")
